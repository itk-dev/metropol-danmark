<?php
// $Id: class.csstidy.php,v 1.4 2010/10/07 18:05:17 philbar Exp $

/**
 * @file
 * This is the file which runs all of the CSSTidy library.
 */
 ...
 */
  ...
  $this->settings['multiple_properties'] = array('cursor', 'src');
}
