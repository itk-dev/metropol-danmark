<?php 
	...
	$publishDateView = t(format_date($node->created, 'custom', 'd.m.y'));
	$author = $node->name;
...
<div id="<?php print $node_id; ?>" class="<?php print $classes; ?>">
  ...
  <?php endif; ?>
	<?php if($pageTeaser):?>
		<div class="page-teaser"><span><?php $page ? print 'Nyhed.' : print $publishDateView ?> </span><?php print $pageTeaser ?></div>
	<?php endif; ?>
